...
deploydocs(
    repo="https://PaoloGiordani/HybridTreeBoosting.jl.git", # GitHub complained that I should remove the protocol. Originally repo="https://github.com/PaoloGiordani/HybridTreeBoosting.jl.git"
    target="build",
    branch = "gh-pages",  # 
    devbranch="main",
