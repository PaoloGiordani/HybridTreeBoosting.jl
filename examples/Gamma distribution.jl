...
- loss=:gamma clearly outperforms loss=:L2 in terms of out-of-sample RMSE if only the standard identity link is used, 
  but :L2 approaches the performance of :gamma if the link is cross-validated (as default if modality in [:compromise,:accurate]).
  IS THIS TRUE? SEE MY SIMULATION .... 
